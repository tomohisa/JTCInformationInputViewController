#
#  Be sure to run `pod spec lint JTCInformationInputViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of JTCInformationInputViewController in Markdown format.
  ...
  s.source       = { :git => "https://github.com/tomohisa/JTCInformationInputViewController.git", :tag => "v0.1.0" }
