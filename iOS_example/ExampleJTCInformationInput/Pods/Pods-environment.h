...
// JTCCommon
#define COCOAPODS_POD_AVAILABLE_JTCCommon
#define COCOAPODS_VERSION_MAJOR_JTCCommon 0
#define COCOAPODS_VERSION_MINOR_JTCCommon 1
#define COCOAPODS_VERSION_PATCH_JTCCommon 0
